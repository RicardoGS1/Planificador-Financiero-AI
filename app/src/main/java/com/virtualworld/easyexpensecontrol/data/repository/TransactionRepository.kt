...
class TransactionRepository(private val transactionDao: TransactionDao) : TransactionRepositoryDomain {
    ...
    override suspend fun countAutoGeneratedForRecurringInMonth(recurringId: Long, yearMonth: Int): Int {
        return transactionDao.countAutoGeneratedForRecurringInMonth(recurringId, yearMonth.toString())
    }
}
